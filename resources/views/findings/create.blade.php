...
<div class="glass-card" style="padding: 40px; max-width: 800px; border-radius: 24px;">
    <form action="{{ route('findings.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div style="display: flex; gap: 16px;">
            ...
            <a href="{{ route('findings.index') }}" class="btn-primary" style="flex: 1; height: 52px; background: rgba(255,255,255,0.05); color: var(--text-main); border: 1px solid var(--border);">
                Batal
            </a>
        </div>
    </form>
